      ...
      <div className="donation-content">
        ...
        <div className="donation-info">
          ...
          <p className="donation-page-description">
            Tu ayuda es fundamental. Puedes registrar tu donación aquí de forma rápida, incluso anónima.
          </p>
          ...
          <div className="donation-benefits">
            <div className="benefit-item">
              ...
              <div className="benefit-text">
                <span className="benefit-title">Impacto Directo</span>
                <span className="benefit-description">
                  Tus donaciones llegan directamente a familias necesitadas.
                </span>
              </div>
            </div>
            ...
            <div className="benefit-item">
              ...
              <div className="benefit-text">
                <span className="benefit-title">Privacidad Garantizada</span>
                <span className="benefit-description">
        ...
        <div className="donation-form-section">
          ...
          <div className="donation-form-grid">
            <div className="form-group">
              ...
              <input
                type="text"
                className={`form-input donation-input ${errores.producto ? "input-error" : ""}`}
            ...
            <div className="form-group">
              ...
              <div className="select-wrapper">
                <select
                  className={`form-select donation-select ${errores.tipo ? "input-error" : ""}`}
                  value={tipo}
          ...
          <div className="donation-form-grid">
            <div className="form-group">
              ...
              <input
                type="number"
                className={`form-input donation-input ${errores.cantidad ? "input-error" : ""}`}
                placeholder="0"
                value={cantidad}
                onChange={(e) => setCantidad(e.target.value)}
              />
              {errores.cantidad && <p className="error-text">{errores.cantidad}</p>}
            </div>
